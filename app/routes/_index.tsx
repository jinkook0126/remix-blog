...
export const meta = () => [
  ...
  { name: "description", content: "눈이 편안한 디자인과 반응형 레이아웃을 갖춘 현대적인 블로그 플랫폼입니다." },
  { property: "og:title", content: "Dairium Blog" },
  { property: "og:description", content: "눈이 편안한 디자인과 반응형 레이아웃을 갖춘 현대적인 블로그 플랫폼입니다." },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-secondary-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                <span className="highlight-purple"> 유용한 정보</span>를 만나보세요.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-secondary-600">
                  ...
                  모바일부터 데스크톱까지 완벽하게 대응합니다.
                </p>
              </div>

              <div className="text-center">
                <div className="w-16 h-16 bg-highlight-purple/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-highlight-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
